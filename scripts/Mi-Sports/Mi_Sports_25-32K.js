...
Surge
[Script]
小米运动 = type=cron,cronexp="15 17 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Semporia/Quantumult-X/master/scripts/Mi-Sports/Mi_Sports.js
小米运动获取Token = type=http-response,pattern=^https:\/\/account\.huami\.com\/v2\/client\/login, requires-body=1, max-size=0, script-path=backUp/https://raw.githubusercontent.com/Semporia/Quantumult-X/master/scripts/Mi-Sports/Mi_Sports.js
Quantumult X
[task_local]
# 小米运动
...
Loon
[Script]
cron "15 17 * * *" script-path=https://raw.githubusercontent.com/Semporia/Quantumult-X/master/scripts/Mi-Sports/Mi_Sports.js, tag=小米运动
http-response ^https:\/\/account\.huami\.com\/v2\/client\/login script-path=https://raw.githubusercontent.com/Semporia/Quantumult-X/master/scripts/Mi-Sports/Mi_Sports.js, requires-body=true, timeout=3600, tag=小米运动获取Token
 */
...
const step = randomFriendPin($.getdata('xmMinStep')*1 || 25000, $.getdata('xmMaxStep')*1 || 32000);
function getToken() {
  if ($response.body) {
